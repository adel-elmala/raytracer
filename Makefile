...
test: src/test.cpp \
	...
	$(CC) $(FLAGS) $(INCLUDE) src/test.cpp src/Light.cpp src/Plane.cpp src/Sphere.cpp src/GeometricObject.cpp  src/ViewPlane.cpp src/World.cpp src/Camera.cpp src/RGBColor.cpp src/Vector3.cpp src/Point3.cpp src/Point2.cpp src/Normal3.cpp src/Ray.cpp -o ./bin/$@
